main(){
  ...
  // 데이터 삭제 : 촉을 삭제
  threeKingdoms.removeAt(1); // Index 번호로 삭제
  threeKingdoms.remove('We'); // Value로 삭제

  // List의 데이터 갯수 파악
  print(threeKingdoms.length);

  // threekingdoms에 숫자 추가하기
  threeKingdoms.add(1);
  ...
  // threeKingdoms2.add("We"); // 문자만 등록 가능(위에서 제너릭을 String으로 정했기 때문)

  print(threeKingdoms2);

  print('============================');

  // List 선언 시 초기값 할당 후 실행
  List<String> threeKingdoms3 = ['위','촉','오'];
  
  // 위나라가 삼국을 통일했습니다.
  print('${threeKingdoms3[0]}나라가 삼국을 통일했습니다.');
